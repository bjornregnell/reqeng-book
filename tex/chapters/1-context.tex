...
\noindent Requirements Engineering (RE) is the sub-discipline of Software Engineering (SE) that is focused on the \textit{requirements} of software-intensive systems and their \textit{context}, which includes users and surrounding systems. 
...
Different kinds of products, markets, business models.
