...
\input{../lectures/slides/data-dictionaries-generated.tex}
...
\MarginPage{
\input{../lectures/slides/data-modeling-generated.tex}
}% 
...
% Or should this go into product scoping?
...
\subsection{Modeling and abstraction}

\subsection{Generic tools and techniques}
  pedagogics, communication and presentation

  word processors, presentation tools, drawing tools , issue trackers 

  mindmapping, project management, decision-making

  AI and Large language models 


\subsection{RE-specific language}
...
\subsubsection{reqT-lang: a requirements metalanguage}

The reqT meta-model cheat-sheet

\subsection{RE-specific tools}
