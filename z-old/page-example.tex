...
{0.0ex} % sep
{} % before-code
[\vspace{-0.0em}\rule{\columnwidth}{0.5pt}\vspace{0.5em}]% after-code
...
\begin{mdframed}[backgroundcolor=blue!10]\relax
  \fontfamily{qhv}\fontsize{9}{11}\selectfont  %qhv phv lmss cmss
...
\node[align=left,yshift=0mm,xshift=5mm] at (0.53\paperwidth, 0.12\paperheight) { %  add draw, before align to get frame
\begin{minipage}{90mm}
#1
\end{minipage}%
};
...
\MarginPage{%
\input{../tex/slides/01-what-is-RE.tex}
