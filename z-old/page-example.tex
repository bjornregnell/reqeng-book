...
\titlespacing*{\chapter}{0.0em}{0.0em}{1.0em}
...
\usepackage{multicol} \setlength{\columnsep}{15mm}  % for multocolumn parts
...
\newgeometry{hmargin={2.5cm,2.5cm},vmargin={2cm,2cm}}
...
\newgeometry{hmargin={4.5cm,12.5cm},vmargin={2cm,2cm}}
...
\begin{tikzpicture}[remember picture, overlay, shift=(current page.south west)]
  \node[draw,align=left,fill=blue!10, fill opacity=0.8] at (23.5cm,15cm) {
